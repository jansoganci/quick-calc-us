...
| [`US_DETAILED_FEASIBILITY_SCOPE.md`](./US_DETAILED_FEASIBILITY_SCOPE.md) | Detailed Feasibility scope and locked decisions (v0.1, owner locks UD-1…UD-4). Not yet a full formula-level financial specification |
